...
window.addEventListener("load", () => {
  ...
  if (location.pathname === "/ui/admin_index.html") {
    adminHomePageLoad();
  }

  if (location.pathname === "/ui/add_product.html") {
  ...
  if (location.pathname === "/ui/product_detail.html") {
    loadUserPage();
  }

  if (location.pathname === "/ui/user_cart.html") {
    cartPageLoad();
  }

  if (
    location.pathname === "/ui/product_detail.html" ||
    location.pathname === "/ui/user_orders.html" ||
    location.pathname === "/ui/user_cart.html"
  ) {
    updateCartCount();
  }

  if (location.pathname === "/ui/user_orders.html") {
    orderPageLoad();
  }

  if (location.pathname === "/ui/admin_orders.html") {
    adminOrderPageLoad();
  }
});
...
deleteCartBodyProducts = (id) => {
  ...
  location.reload("/ui/user_cart.html");
  cartPageLoad();
};
